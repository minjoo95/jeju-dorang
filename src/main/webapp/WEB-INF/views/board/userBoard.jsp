...
<div class = "container" id = "board-container">
	...
	<span>${user.user_nickname} 후기</span>
	...
	<nav aria-label="Page navigation example">
		<ul class="btn-group pagination">
			...
			<li class="page-item">
				<a class="page-link" href="<c:url value='/board/userBoard?page=${pageMaker.startPage-1 }'/>" aria-label="Previous">
			...
			<li class="page-item">
				<a class="page-link" href="<c:url value='/board/userBoard?page=${pageNum }'/>">${pageNum }</a>
			</li>
			</c:forEach>
			<c:if test="${pageMaker.next && pageMaker.endPage >0 }">
			<li class="page-item">
				<a class="page-link" href="<c:url value='/board/userBoard?page=${pageMaker.endPage+1 }'/>" aria-label="Next">
