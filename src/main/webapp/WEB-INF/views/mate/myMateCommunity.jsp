...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" type="text/css"  href="<c:url value="/resources/css/myMateCommunity.css"/>">
  ...
  <jsp:include page="../headerBoot.jsp"></jsp:include>
    ...
    <div class="container" style="padding:50px 0px" >
     <div class="d-flex" >
		  <button data-btn="list" class="btn list_btn">
					동행목록가기
		  </button>
	</div>
          ...
          <div class="row">
	          <div class="col-md-6  container_1" >
		 			 ...
		 			 <input type="hidden" name="mate_title" id="mate_title" value="${mt.title}"/>
					    <label  class="form-label">${mt.title}</label>
		  			 </div> 
		  			  <!-- 이미지 --> 
					<div class="mb-5">
					  	 <div class="card">
