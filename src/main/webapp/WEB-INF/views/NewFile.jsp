	...
	<nav class="header-nav">
		<div class="header-wrap">
			...
			<ul class="header-category">
				...
				<li class="navi-item">
					<a class="navi-link navi-link-mypage" id="hiddenTT" href="${contextPath }/user/mypage">마이페이지</a>
				</li>
			</ul>		
				...
				<div class="header-menubar-icon"><i class="fa-solid fa-bars" id="hidden-burger-menu"></i></div>
			</div>
		</div>
	</nav>
</div>
